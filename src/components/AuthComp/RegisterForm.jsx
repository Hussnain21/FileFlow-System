...
const RegisterForm = () => {
    ...
    return (
        <form >
            ...
            <div className="form-group my-2">
                <input type="password" name="passwordConfirmation" className="form-control" placeholder='Confirm Password' value={passwordConfirmation}
                onChange={(e) => setPasswordConfirmation(e.target.value)} />
            </div>
            <button className="submit btn btn-primary my-2 form-control">Register</button>
        </form>   
    )
}
